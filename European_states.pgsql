...
COPY states.state FROM 'States1.csv' DELIMITER ',' CSV HEADER;
COPY states.type_government FROM 'States3.csv' DELIMITER ',' CSV HEADER;
COPY states.state_details FROM 'States2.csv' DELIMITER ',' CSV HEADER;
COPY states.language FROM 'States4.csv' DELIMITER ',' CSV HEADER;
COPY states.states_official_languages FROM 'States5.csv' DELIMITER ',' CSV HEADER;
